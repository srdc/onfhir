...
package object api {
  ...
  val FHIR_PARAMETER_TYPE_TARGETS = scala.collection.immutable.Map(
    ...
    FHIR_PARAMETER_TYPES.QUANTITY -> Set(FHIR_DATA_TYPES.QUANTITY, FHIR_DATA_TYPES.SIMPLE_QUANTITY, FHIR_DATA_TYPES.MONEY_QUANTITY, FHIR_DATA_TYPES.COUNT, FHIR_DATA_TYPES.DURATION, FHIR_DATA_TYPES.DISTANCE, FHIR_DATA_TYPES.AGE, FHIR_DATA_TYPES.RANGE, FHIR_DATA_TYPES.SAMPLED_DATA)
  )
