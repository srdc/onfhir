...
trait IFhirTerminologyTranslationService {
   ...
   * @return                    Resulting Parameters resource if successful
   */
  def translate(code:String, system:String, conceptMapUrl:String, version:Option[String], conceptMapVersion:Option[String], reverse:Boolean):Future[Option[JObject]]
   ...
   * @return                    Resulting Parameters resource if successful
   */
  def translate(code:String, system:String, conceptMapUrl:String):Future[Option[JObject]]
   ...
   * @return                          Resulting Parameters resource if successful
   */
  def translate(codingOrCodeableConcept:JObject, conceptMapUrl:String, conceptMapVersion:Option[String], reverse:Boolean):Future[Option[JObject]]
   ...
   * @return                          Resulting Parameters resource if successful
   */
  def translate(codingOrCodeableConcept:JObject, conceptMapUrl:String):Future[Option[JObject]]
   ...
   * @return            Resulting Parameters resource if successful
   */
  def translate(code:String, system:String, source:Option[String], target:Option[String], version:Option[String], reverse:Boolean):Future[Option[JObject]]
   ...
   * @return            Resulting Parameters resource if successful
   */
  def translate(code:String, system:String, source:Option[String], target:Option[String]):Future[Option[JObject]]
   ...
   * @return            Resulting Parameters resource if successful
   */
  def translate(codingOrCodeableConcept:JObject, source:Option[String], target:Option[String], reverse:Boolean):Future[Option[JObject]]
   ...
   * @return                          Resulting Parameters resource if successful
   */
  def translate(codingOrCodeableConcept:JObject, source:Option[String], target:Option[String]):Future[Option[JObject]]
}
