...
object FhirResourceMutator {
  ...
  class FhirMutableResource(resource:Resource) {
     ...
     * @return
     */
    def addElement(fhirPath:String, name:String, value:JValue, isArray:Boolean = false):Resource = {
      parsePath(fhirPath)
    ...
    */
    ...
    def addElementOrThrowExc(fhirPath:String, name:String, value:JValue, isArray:Boolean = false):Resource = {
      parsePath(fhirPath) match {
     ...
     * @return
     */
    def addRootElement(name:String, value:JValue, isArray:Boolean = false):Resource =
      FhirPatchUtil.applyAddPatch(resource, Nil, name, value, isArray)
    ...
    @throws[IllegalArgumentException]
    def insertElement(fhirPath:String, index:Int, value:JValue):Resource = {
      parsePath(fhirPath)
    ...
    @throws[IndexOutOfBoundsException]
    @throws[IllegalArgumentException]
    def insertElementOrThrowExc(fhirPath:String, index:Int, value:JValue):Resource = {
      parsePath(fhirPath) match {
        case None => throw new IllegalArgumentException(s"Given FHIR path $fhirPath does not indicate any element for the given resource!")
     ...
     * @return
     */
    def deleteElement(fhirPath:String):Resource = {
      parsePath(fhirPath)
     ...
     */
    @throws[IllegalArgumentException]
    def deleteElementOrThrowExc(fhirPath:String):Resource = {
      parsePath(fhirPath) match {
        case None => throw new IllegalArgumentException(s"Given FHIR path $fhirPath does not indicate any element for the given resource!")
     ...
     * @return
     */
    def replaceElement(fhirPath:String, value:JValue):Resource = {
      parsePath(fhirPath).map(parsedPath =>
     ...
     */
    @throws[IllegalArgumentException]
    def replaceElementOrThrowExc(fhirPath:String, value:JValue):Resource = {
      parsePath(fhirPath) match {
        case None => throw new IllegalArgumentException(s"Given FHIR path $fhirPath does not indicate any element for the given resource!")
    ...
    @throws[IndexOutOfBoundsException]
    @throws[IllegalArgumentException]
    def moveElement(fhirPath:String, source:Int, destination:Int):Resource = {
      parsePath(fhirPath).map(parsedPath =>
    ...
    @throws[IndexOutOfBoundsException]
    @throws[IllegalArgumentException]
    def moveElementOrThrowExc(fhirPath:String, source:Int, destination:Int):Resource = {
      parsePath(fhirPath) match {
        case None => throw new IllegalArgumentException(s"Given FHIR path $fhirPath does not indicate any element for the given resource!")
