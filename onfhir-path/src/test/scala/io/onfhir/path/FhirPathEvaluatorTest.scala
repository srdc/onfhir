...
//      evaluator.evaluateOptionalTime("'09:05'.utl:toFhirDateTime('HH:mm').lowBoundary()", JNull).head._1.format(DateTimeFormatter.ofPattern("HH:mm:ss.SSS")) mustEqual "09:05:00.000"
